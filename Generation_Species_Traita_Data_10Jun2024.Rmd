...
# 1. List of South American birds with dry diagonal information
south_american <- full_join(sacc_birds, dd_birds, by = "Birdtree_tiplabel")

# 2. Consolidated List of South American birds with their ecological and morphological data from AVONET
